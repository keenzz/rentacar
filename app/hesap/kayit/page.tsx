      ...
      <div className="max-w-md mx-auto bg-white p-8 rounded-lg shadow-md">
          ...
          <div className="mb-6">
            <div className="flex items-center">
              ...
              <label htmlFor="terms" className="text-gray-700">
                <a href="/sartlar" className="text-blue-600 hover:underline">Şartlar ve Koşulları</a> okudum ve kabul ediyorum.
              </label>
            </div>
          </div>
        ...
        <div className="mt-6 text-center">
          <p className="text-gray-700">
            ...
            <Link href="/hesap/giris" className="text-blue-600 hover:underline ml-1">
              Giriş Yapın
            </Link>
          </p>
        </div>
